...
function Movie_row({movie,onDelete,handleLike,handleDislike}){
  return(
    <>
        <div className="row4">
            <div className="col row4_col1">
                ...
                <div className="col row4_col2">
                        ...
                        <span className="Text col2text2">{movie.relemoviedataase_date}</span>
                        <h3>Description</h3>
                        ...
                        <>
                          ...
                          <Rating  handleLike={handleLike} handleDislike={handleDislike} />
                        </>
                </div>
        </div>
